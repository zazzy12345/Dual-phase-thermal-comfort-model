...
def get_txt_path(img_file_path):
    ...
    preFolder = "D:/MasterDegree/code/dataset/summer_additional_feature_all/"
    new_string = preFolder + new_string
...
# @function:获取环境特征,拼接多个图片的辅助特征
# @input:批量图片的地址集合
def get_additional_features(file_paths):
